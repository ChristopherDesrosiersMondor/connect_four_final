...
class Ai_C4(Joueureuse):
    ...
    def moves(self, node: TNode, h: int) -> None:
        ...
        #Prendre le board state et remplir ton objet board que tu copies juste une fois.
        #temp_board.fill(board_state)
    ...
    def next_move(self, board: Board, h: int = HAUTEUR) -> int:
        #Passer board en matrice comme board state 
